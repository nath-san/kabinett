  ...
  return (
    ...
    >
      <img
        ...
        className={[
          "absolute inset-0 w-full h-full object-cover will-change-transform lg:group-hover:scale-[1.03]",
          eager ? "transition-transform duration-700 ease-out" : "opacity-0 transition-all duration-700 ease-out",
        ].join(" ")}
      />
