...
const COLLECTIONS: Collection[] = [
  { title: "Mörkt & dramatiskt", subtitle: "Skuggor och spänning", query: "natt mörker", museum: "nm", imageIds: [24664, 20450, 15634] },
  { title: "Ljust & stilla", subtitle: "Sommar och ro", query: "sommar landskap", museum: "nm", imageIds: [20993, 20523, 23027] },
  { title: "Stormigt hav", subtitle: "Vågor och vind", query: "hav storm", imageIds: [17939, 17176, 17567, 18218, 21087] },
  { title: "Blommor", subtitle: "Natur i närbild", query: "blommor", imageIds: [17457, 17458, 18106, 154102, 18360] },
  { title: "Djur i konsten", subtitle: "Hästar, hundar och fåglar", query: "djur häst hund", imageIds: [15877, 14792, 18888, 19063, 17875] },
  ...
  { title: "Mytologi", subtitle: "Gudar och hjältar", query: "venus gudinna", museum: "nm", imageIds: [17313, 17387, 17773, 17613, 15488] },
  { title: "Vinter", subtitle: "Snö och is", query: "vinter snö", imageIds: [18895, 19942, 20431, 21900, 23019] },
  ...
  { title: "Arkitektur", subtitle: "Slott och kyrkor", query: "slott kyrka", imageIds: [15506, 15482, 17539, 17958, 14754] },
];
